...
Ball* StageOneBall::copyBall(){
    return new StageOneBall(m_brush.color(),m_pos,m_velocity,m_mass,m_radius);
}
...
Ball* CompositeBall::copyBall() {
    CompositeBall *copy = new CompositeBall(m_brush.color(),m_pos,m_velocity,m_mass,m_radius,m_strength);
